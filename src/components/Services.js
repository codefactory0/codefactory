                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        ...
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-normal'>We can work alongside your existing team to enhance your current solutions or develop custom solutions specific to your needs. Our focus is on simplifying processes, improving efficiency, and providing seamless digital experiences. Let’s create solutions that fit perfectly into your workflow and help you achieve greater success.</p>
                            </div>
                        </div>
                    </div>
                </div>
